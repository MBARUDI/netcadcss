...
## Docelyna Confeitaria
Bem-vindo ao repositório do projeto Docelyna, um website de uma confeitaria online, desenvolvido para apresentar produtos, gerenciar pedidos e fornecer informações de contato de forma elegante e intuitiva.

##📋 Sobre o Projeto
O Docelyna Confeitaria é um site de demonstração focado em design e usabilidade. Ele oferece uma experiência de navegação agradável para clientes que desejam explorar nosso catálogo de doces, bolos e sobremesas, além de ter funcionalidades básicas para contato e informações sobre a empresa.

## ✨ Principais Funcionalidades
Catálogo de Produtos: Uma galeria visualmente atraente para exibir os produtos com descrições detalhadas.
